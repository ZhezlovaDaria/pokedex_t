...
public class Pokemon {
    ...
    public void setGameIndice(List<GameIndice> game_indices) {
    ...
    public void setHeldItems(List<HeldItem> held_items) {
    ...
    public int getStats(int num) {
        return stats.get(num).base_stat;
    }
